...
// @ts-ignore
const { ReactMic } = dynamic(() => import("react-mic"), { ssr: false });
import { useDispatch, useSelector } from "react-redux";
// import OfflineIcon from "../";
...
export default function HomeScreen() {
  ...
  // const [synth, setSynth] = React.useState<any>(null);
  // const sessionCtx = useSelector((state: any) => state.speech.session);
  ...
  //       dispatch(addQuery({ query, uid } as unknown as any));
  ...
  return (
    <Center pt="44" overflow={"clip"} flexDir="column">
      ...
      {sessionCtx && sessionCtx.type === "memes" && (
        <Session session={sessionCtx} />
      )} */}
      <div>This is Homer</div>
    </Center>
  );
}
